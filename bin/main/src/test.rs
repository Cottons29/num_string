...
#[test]
fn test_sub_greater_digit(){
    let first = NumberString::from("1000");
    let second = NumberString::from("900");

    let res = first - second;

    assert_eq!(res, NumberString::from("100"));
}
...
#[test]
fn test_mul_same_result(){
    let a = NumberString::from("333");
    let b = NumberString::from("3");
    let res = a * b;

    assert_eq!(res, NumberString::from("999"));
}
// #[test]
// fn test_div_same_result(){
//     let a = NumberString::from("1000");
//     let b = NumberString::from("3");
//     let res = a / b;
//     
//     assert_eq!(res, NumberString::from("333"));
// }
#[test]
...
#[test]
fn div_test_big_small(){
    let fl1 = FloatNumberString::new_with_string("1.0");
    let fl2 = FloatNumberString::new_with_string("0.001");

    let res = fl1 / fl2;
    assert_eq!(res, FloatNumberString::from("1000.0"));
}

#[test]
fn div_test_infinity_frac(){
    let fl1 = FloatNumberString::new_with_string("10.00");
    let fl2 = FloatNumberString::new_with_string("3.00");
    let res = fl1 / fl2;
    assert_eq!(res, FloatNumberString::from("3.3333333333333333333"));
}
#[test]
fn div_test_infinity_frac2(){
    let fl1 = FloatNumberString::new_with_string("10.00");
    let fl2 = FloatNumberString::new_with_string("3.00");
    let res = fl1 / fl2;
    assert_eq!(res, FloatNumberString::from("3.3333333333333333333"));
